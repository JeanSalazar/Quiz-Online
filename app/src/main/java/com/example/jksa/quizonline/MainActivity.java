...
public class MainActivity extends AppCompatActivity
    ...
    private void abrirAcercaDeActivity(){
    ...
    public void onClickDocente(View view){
        Intent intent = new Intent(MainActivity.this,OpcionesDocenteActivity.class);
        startActivity(intent);
    }


    public void onClickAlumno(View view){
